<?php
class metafad_mag_views_components_FilePicker extends pinaxcms_mediaArchive_views_components_FilePicker
{
    function init()
    {
        parent::init();
	...
	public function render($outputMode=NULL, $skipChilds=false)
	{
        ...
        $customPath = ($this->getAttribute('customPath')) ?: __Config::get('metafad.MAG.folder');
