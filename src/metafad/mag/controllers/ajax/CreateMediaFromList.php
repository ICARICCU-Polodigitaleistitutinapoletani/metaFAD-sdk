<?php
class metafad_mag_controllers_ajax_CreateMediaFromList extends metafad_common_controllers_ajax_CommandAjax
{
  public function execute($stru = null, $key = null, $id = null, $type = '')
  {
    ...
    foreach ($physicalStru as $elements) {
      ...
      foreach ($elements as $e) {
        if (in_array($e->id, $key)) {
          ...
          $docStruProxy->saveNewMedia($e, $rootId->docstru_id, $count, $type);
          $count++;
        }
      }
    }
