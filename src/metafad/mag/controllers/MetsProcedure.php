<?php
class metafad_mag_controllers_MetsProcedure extends metafad_common_controllers_Command
{
	public function execute()
	{
		...
		$uploaddir = __Config::get('metafad.importer.uploadFolder');
		...
		if (!count($listMag)) {
			$this->logAndMessage('Non ci sono file .xml compatibili nel pacchetto caricato', '', PNX_LOG_ERROR);
		} else {
