...
class metafad_exporter_services_metsexporter_METSExporter extends PinaxObject
{
  private $countU = 1;
  private $dam;

  function METSExport($UAD, $instance = null, $nomefile)
  {

    $dirRead = pinax_findClassPath("metafad/exporter/services/metsexporter/input", false) . "/";
    $dirWrite = "./export/";
    $this->dam = pinax_ObjectFactory::createObject('metafad.dam.services.ImportMedia', $instance);
    ...
    $recUA = pinax_ObjectFactory::createModel('archivi.models.UnitaArchivistica');
    $recUD = pinax_ObjectFactory::createModel('archivi.models.UnitaDocumentaria');
    $recAntro = pinax_ObjectFactory::createModel('archivi.models.Antroponimi');
    $recEnti = pinax_ObjectFactory::createModel('archivi.models.Enti');
    $recTopon = pinax_ObjectFactory::createModel('archivi.models.Toponimi');
    ...
    foreach ($UAD as $idUAD) {
      ...
      $docType = pinax_ObjectFactory::createModelIterator(
        'metafad.exporter.models.Scheda',
        'docType',
      ...
      if ($docType->current()->document_type == 'archivi.models.UnitaArchivistica') {
        ...
        $add = $this->commonFieldsToRead($rXpath, $nodeRec, $data, $recAntro, $docRead, $recEnti, $recTopon, $instance);
  ...
  public function commonFieldsToRead(&$rXpath, &$nodoRec, &$data, &$recAntro, &$docRead, &$recEnti, &$recTopon, $instance)
  {
    ...
    $this->insertOrRemoveNode(
      $data->cronologia[0]->estremoCronologicoTestuale,
      $nodoRec,
      $rXpath,
      "./envelope:recordBody/mets:mets/mets:dmdSec[@ID='ead-desc-001']/mets:mdWrap/mets:xmlData/ead:c/ead:did",
      "ead:unitdate",
