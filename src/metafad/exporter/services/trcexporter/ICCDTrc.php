<?php
class metafad_exporter_services_trcexporter_ICCDTrc extends PinaxObject{
	...
	static function line($field, $value = '')
	{
	    ...
	    return "$field:" . ((!empty($value) || $value === '0') ? metafad_exporter_services_trcexporter_ICCDTrc::spaceGenerator(7, $key_length, 2) . metafad_exporter_services_trcexporter_ICCDTrc::getNewlinedText($value) : '') . "\r\n"; //MZ aggiunto \r
	}
