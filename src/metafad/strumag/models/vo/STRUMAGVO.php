<?php
class metafad_strumag_models_vo_STRUMAGVO
{
    public $id;
    public $MAG;
    public $title;
    ...
    public function __construct($ar)
    {
        ...
        $this->physicalSTRU->documents = ($physicalSTRU->documents)?:[];
        $this->physicalSTRU->audio = ($physicalSTRU->audio) ?: [];
        $this->physicalSTRU->video = ($physicalSTRU->video) ?: [];
