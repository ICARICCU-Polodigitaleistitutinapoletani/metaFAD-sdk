...
class metafad_thesaurus_controllers_ajax_Export extends metafad_common_controllers_ajax_CommandAjax
{
    ...
    pinax_importApplicationLib('PHPExcel/Classes/PHPExcel/Writer/Excel2007.php');
    $model = pinax_ObjectFactory::createModelIterator( 'metafad.thesaurus.models.ThesaurusDetails' )
    ...
    $count = 2;
    foreach ($final as $f) {
      $findParent = pinax_ObjectFactory::createModelIterator( 'metafad.thesaurus.models.ThesaurusDetails' )->where('thesaurusdetails_id', $f[3])->first();
