...
class metafad_thesaurus_controllers_ajax_Import extends metafad_common_controllers_ajax_CommandAjax
{
    public function execute()
    {
        ...
        if ($_FILES) {
            ...
            if(__Request::get('Cancella_tutti') === 'true'){
                ...
                metafad_Metafad::logAction('metafad_thesaurus_controllers_ajax_Import delete id:'.$idDizionario, 'thesaurus');
                foreach ($it as $ar) {
                    $ar->delete();
                }
            }
            ...
            foreach ($arrayData as $key => $row) {
                ...
                if (__Request::get('Sostituisci_record') === 'true') {
                    ...
                    metafad_Metafad::logAction('metafad_thesaurus_controllers_ajax_Import delete key:'.$row[1], 'thesaurus');
                    foreach ($it as $ar) {
                        $ar->delete();
                    }
                }
