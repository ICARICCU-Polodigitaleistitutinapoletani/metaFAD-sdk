<?php
class metafad_thesaurus_controllers_ajax_AddRecord extends metafad_common_controllers_ajax_CommandAjax
{
    public function execute()
    {
        ...
        $term = pinax_ObjectFactory::createModel('metafad.thesaurus.models.Details');
        ...
        $term->thesaurusdetails_creationDate = new pinax_types_DateTime();
        $term->thesaurusdetails_modificationDate = new pinax_types_DateTime();
