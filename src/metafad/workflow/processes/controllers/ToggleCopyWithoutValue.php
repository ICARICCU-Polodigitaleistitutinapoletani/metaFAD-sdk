...
class metafad_workflow_processes_controllers_ToggleCopyWithoutValue extends metafad_common_controllers_Command
{
...
// TODO controllo ACL
        if ($id) {
            ...
            pinax_helpers_Navigation::gotoUrl(pinax_helpers_Link::makeUrl('metafad.workflow.processes',
