<?php
class metafad_gestioneDati_sbnweb_views_components_SBNForm extends pinax_components_Component
{
  private $count = 1;
  ...
  function process()
  {
    ...
    else
    {
      ...
      $this->_content['html'] = $this->exploreJson($file->records[0]->nodes,1) . $buttons;
