<?php
class metafad_gestioneDati_boards_views_components_LinkToSbn extends pinax_components_Component
{
    function init()
    {
    ...
    public function render($outputMode=NULL, $skipChilds=false)
    {
      ...
      if($recordId)
      {
        $sbn = pinax_ObjectFactory::createModelIterator($module.'.model.Model')
