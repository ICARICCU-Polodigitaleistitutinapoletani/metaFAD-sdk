<?php
class metafad_gestioneDati_boards_views_components_RozRelations extends pinax_components_Component
{
    function init()
    {
        parent::init();
    ...
    public function render($outputMode=NULL, $skipChilds=false)
    {
        ...
        $roz = pinax_ObjectFactory::createModelIterator('metafad.gestioneDati.boards.models.Relations')
