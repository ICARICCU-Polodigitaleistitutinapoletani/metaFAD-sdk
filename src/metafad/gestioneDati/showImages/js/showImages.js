...
function refreshComponentById(pinaxComponentId, htmlDestNodeId, recordId, action, stripScripts)
{
  stripScripts = typeof stripScripts !== 'undefined' ? stripScripts : true;
  $.ajax({
    url: Pinax.ajaxUrl + '&controllerName=metafad.common.controllers.ajax.RerenderComponent',
    type: 'POST',
    data: {
      "sendOutput": pinaxComponentId,
