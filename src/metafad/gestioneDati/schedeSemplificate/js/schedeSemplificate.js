$(document).on('change','#form',function(){
    ...
    $.ajax({
      url: Pinax.ajaxUrl + '&controllerName=metafad.gestioneDati.schedeSemplificate.controllers.ajax.RefreshFieldsList',
      type: 'POST',
      data: {
        moduleName: value
      },
...
$(document).ready(function(){
  ...
  $('.js-save').on('click',function(){
    ...
    if(type == 'save')
    {
      $('.js-pinaxcms-saveNotClose').trigger('click');
    }
    else
    {
      $('.js-pinaxcms-saveClose').trigger('click');
    }
  });
