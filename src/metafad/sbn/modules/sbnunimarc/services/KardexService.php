<?php
class metafad_sbn_modules_sbnunimarc_services_KardexService extends PinaxObject
{
    ...
    public function getData($url, $force=false)
    {
        ...
        $ar = pinax_ObjectFactory::createModel('metafad.sbn.modules.sbnunimarc.model.Kardex');
        ...
        if (!$ar->find($query) || $force)  {
            ...
            $ar->kardex_creationDate = new pinax_types_DateTime();
            $ar->kardex_modificationDate = new pinax_types_DateTime();
            $ar->save();
        }
    ...
    public function updateFE($bid)
    {
        ...
        $it = pinax_ObjectFactory::createModelIterator('metafad.sbn.modules.sbnunimarc.model.Kardex')
    ...
    {
        $ar = pinax_ObjectFactory::createModel('metafad.sbn.modules.sbnunimarc.model.Model');
        ...
        $updateSbn = pinax_ObjectFactory::createObject('metafad_sbn_modules_sbnunimarc_model_proxy_UpdateSbnProxy');
