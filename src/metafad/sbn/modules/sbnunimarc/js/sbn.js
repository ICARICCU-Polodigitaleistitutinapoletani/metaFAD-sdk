$(document).ready(function () {
    ...
    setTimeout(function () {
        ...
        $(".OpenGrid").click(function () {
            ...
            $.ajax({
              url: Pinax.ajaxUrl + '&controllerName=metafad.sbn.modules.sbnunimarc.controllers.ajax.RefreshKardexGrid',
              type: 'POST',
              data: {
                kardexUrl : kardexUrl
              },
    ...
    $('input.ResynchKardex').click(function() {
        ...
        if (confirm('I media già associati verranno persi continuare?')) {
            ...
            $.ajax({
                url: Pinax.ajaxUrl + '&controllerName=metafad.sbn.modules.sbnunimarc.controllers.ajax.ResynchKardex',
                type: 'POST',
                data: {
                    url : url
                },
