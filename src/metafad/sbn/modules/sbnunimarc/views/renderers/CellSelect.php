<?php
class metafad_sbn_modules_sbnunimarc_views_renderers_CellSelect extends pinaxcms_contents_views_renderer_AbstractCellEdit
{
    public function renderCell($key, $value, $row, $columnName)
    {
        ...
        $attributes = array(
            ...
            'data-proxy' => 'metafad.strumag.models.proxy.StruMagProxy',
        ...
        $output = pinax_helpers_Html::renderTag('input', $attributes, true);
        return $output;
    }
}
