...
class metafad_sbn_modules_sbnunimarc_views_components_LinkedImages extends pinax_components_Component
{
    function init()
    {
    ...
    public function render($outputMode=NULL, $skipChilds=false)
    {
        ...
        if($ar->linkedStruMag)
        {
          $stru = pinax_ObjectFactory::createModel('metafad.strumag.models.Model');
