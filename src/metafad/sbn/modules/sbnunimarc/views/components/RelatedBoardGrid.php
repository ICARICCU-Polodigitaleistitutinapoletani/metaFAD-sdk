<?php
class metafad_sbn_modules_sbnunimarc_views_components_RelatedBoardGrid extends pinax_components_Component
{
    ...
    function render_html(){
        ...
        <table class="table table-bordered table-striped dataTable" id="$id">
            <thead>
            <tr>
                <th colspan="4" ><span style="float:right; font-weight: 600; cursor: pointer;" class="CloseGrid"><i class="fa fa-close" style="margin-right: 3px"></i>Chiudi</span></th>
            </tr>
                <tr >
                    $headers
                </tr>
                ...
                foreach ($solrResponse->response->docs as $row) {
                    ...
                    foreach ($this->columns as $column) {
                        ...
                        if ($columnRenderCell) {
                            ...
                            if (is_object($columnRenderCell)) {
                                $value = $columnRenderCell->renderCell($row->document_id_nxs, $row->document_id_nxs, $row, $columnName);
                            }
                        }
