<?php
class metafad_usersAndPermissions_relations_models_proxy_RelationsProxy extends PinaxObject
{
    public function delete($userId)
    {
        $model = pinax_ObjectFactory::createModel('metafad.usersAndPermissions.relations.models.Model');
    ...
    {
        $it = pinax_ObjectFactory::createModelIterator('metafad.usersAndPermissions.relations.models.Model')
        ...
        foreach ($it as $ar) {
            if ($institute->id != $ar->user_roles_institutes_FK_instituteId) {
                ...
                $instituteAr = pinax_ObjectFactory::createModel('metafad.usersAndPermissions.institutes.models.Model');
            ...
            $roleAr = pinax_ObjectFactory::createModel('pinaxcms.roleManager.models.Role');
    ...
    {
        $count = pinax_ObjectFactory::createModelIterator('metafad.usersAndPermissions.relations.models.Model')
               ->where('user_roles_institutes_FK_userId', $userId)
    ...
    {
        $ar = pinax_ObjectFactory::createModel('metafad.usersAndPermissions.relations.models.Model');
