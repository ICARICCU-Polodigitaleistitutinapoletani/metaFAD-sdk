 ...
 * Time: 10.31
 */
class metafad_common_importer_MainRunner extends PinaxObject
{
    /**
     * @var $job metafad_jobmanager_service_JobService
     */
    protected $job = null;
    ...
    /**
     * @return metafad_jobmanager_service_JobService
     */
    ...
    /**
     * @param metafad_jobmanager_service_JobService $job
     */
    ...
    public function executeFromStdClasses($ops)
    {
         ...
         */
        $mainRunner = pinax_ObjectFactory::createObject("metafad_common_importer_operations_Runner", $begin, $this);
        try{
