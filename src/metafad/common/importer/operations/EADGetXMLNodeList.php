...
class metafad_common_importer_operations_EADGetXMLNodeList extends metafad_common_importer_operations_LinkedToRunner
{
    ...
    function __construct(stdClass $params, metafad_common_importer_MainRunner $runnerRef)
    {
        ...
        if ($params->config_file) {
            ...
            $configDom->load($params->config_file);
    ...
    {
        $arr = $this->getAllSubNodesBFS($input->document, $this->rootXPath, $this->childXPath, $this->idXPath, $this->recordId);
    ...
    protected function dumpNode($directory, $id, $node)
    {
        /**
         * @var $dump metafad_common_helpers_DOMPrinter
         */
        $dump = pinax_ObjectFactory::createObject("metafad_common_helpers_DOMPrinter");
