<?php
class metafad_common_controllers_rest_GetIccd extends pinax_rest_core_CommandRest
{
	/*
	...
	function execute($model, $code, $institute)
	{
		...
		$dam = pinax_ObjectFactory::createObject('metafad.dam.services.ImportMedia', $institute);
		...
		$form = pinax_ObjectFactory::createModelIterator($model . '.models.Model')
