<?php
class metafad_common_controllers_Command extends pinax_mvc_core_Command
{
    /**
    ...
    protected function checkPermission($service=null, $action=null)
    {
        ...
        if (!$canAccess) {
            pinax_application_MessageStack::add('Permessi non sufficienti per eseguire l\'operazione richiesta', PNX_MESSAGE_ERROR);
