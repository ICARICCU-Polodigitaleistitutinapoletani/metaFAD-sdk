...
class metafad_common_views_components_PageTitle extends pinax_components_PageTitle
{
    protected $parentId;
    protected $icon;
                            ...
                            if ($ar->fieldExists('cronologia')) {
                                ...
                                if (
                                    ...
                                    if ($cronologia[0]->estremoCronologicoTestuale !== '' && $cronologia[0]->estremoRemoto_data === $cronologia[0]->estremoRecente_data) {
                                        ...
                                        $pos = strrpos($recordId, $estremoTestuale);
                                        if ($pos !== false) {
                                            $recordId = substr_replace($recordId, $estremoTestualeMod, $pos, strlen($estremoTestuale));
                                        }
                                    }
                                }
                            }
