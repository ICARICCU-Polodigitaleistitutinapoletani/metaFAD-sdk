<?php
class metafad_common_views_components_DataGridFilter extends pinax_components_Component
{
    function init()
    {
    ...
    public function render($outputMode=NULL, $skipChilds=false)
    {
        ...
        $it = pinax_ObjectFactory::createModelIterator($this->getAttribute('recordClassName'), $this->getAttribute('query'));
        foreach ($it as $ar) {
