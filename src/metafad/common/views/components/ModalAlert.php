...
class metafad_common_views_components_ModalAlert extends pinax_components_Component
{
    function init()
    {
    ...
    public function render($outputMode=NULL, $skipChilds=false)
    {
        ...
        if ($message == 'importICCD') {
            ...
            $addButton = '<input id="import" class="btn btn-primary js-pinaxcms-file" type="button" value="Importa" data-action="import">';
        }
            ...
            $addButton = '<input id="importMassive" class="btn btn-primary js-pinaxcms-importMassive" type="button" value="Importa" data-action="import">';
        }
        else {
