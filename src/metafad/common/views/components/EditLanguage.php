<?php
class metafad_common_views_components_EditLanguage extends pinaxcms_views_components_EditLanguage
{
    function init()
    {
        parent::init();
...
class metafad_common_views_components_EditLanguage_render extends pinax_components_render_Render
{
