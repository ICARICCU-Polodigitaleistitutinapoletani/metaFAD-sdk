<?php
abstract class metafad_common_views_renderer_AbstractCellEdit extends pinax_components_render_RenderCell
{
    use metafad_common_views_renderer_TraitDocumentInCell;
    ...
    protected function renderPreviewButton($key, $row, $enabled = true)
    {
        ...
        $output = '';
        if ($this->canView) {
            $output = '<input id="'.$key.'" name="'.$key.'" class="btn btn-flat js-pinaxcms-preview" type="button" value="Anteprima" data-action="preview">';
        }
