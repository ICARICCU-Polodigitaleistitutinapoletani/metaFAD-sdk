 ...
 */
class metafad_common_models_proxy_SolrQueueProxy extends PinaxObject
{
    ...
    public function commitFE($url)
    {
        $evt = array('type' => 'commitFe', 'data' => array('option' => array('url' => $url)));
        $this->dispatchEvent($evt);
    }
