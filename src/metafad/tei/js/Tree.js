function treeGen() {
    ...
    $(".gerarchia").fancytree({
            ...
            dragDrop: function (node, data) {
                ...
                $('.ok').click(function () {
                    node.setExpanded(true).always(function () {
                        ...
                        $.ajax({
                            url: Pinax.ajaxUrl + '&controllerName=metafad.tei.controllers.ajax.ModifyTree',
                            type: 'get',
                            action: 'modify',
                            dataType: 'json',
                            data: {
        ...
        source: $.ajax({
            url: Pinax.ajaxUrl + '&controllerName=metafad.tei.controllers.ajax.GetTree',
            type: 'get',
            dataType: 'json',
            data: {
                id: id,
        ...
        lazyLoad: function (event, data) {
            ...
            data.result =
                $.ajax({
                    url: Pinax.ajaxUrl + '&controllerName=metafad.tei.controllers.ajax.GetTreeFromParent',
                    type: 'get',
                    dataType: 'json',
                    data: {
                        id: node.data.id
        ...
        renderNode: function (event, data) {
            ...
            addButton.click(function () {
                ...
                if (id) {
                    ...
                    var parentId = data.node.data.id;
                    $.ajax({
                        url: Pinax.ajaxUrl + '&controllerName=metafad.tei.controllers.ajax.GetLevelType',
                        type: 'get',
                        dataType: 'json',
                        data: {
                            id: parentId,
                    ...
                    $('.ok').click(function () {
                        ...
                        $.ajax({
                            url: Pinax.ajaxUrl + '&controllerName=metafad.tei.controllers.ajax.CreateNodeFromParent',
                            type: 'get',
                            dataType: 'json',
                            data: {
                                parentId: parentId,
            ...
            deleteButton.click(function () {
                ...
                $('.ok').click(function () {
                    ...
                    $.ajax({
                        url: Pinax.ajaxUrl + '&controllerName=metafad.tei.controllers.ajax.Delete',
                        type: 'get',
                        action: 'delete',
                        dataType: 'json',
                        data: {
