...
class metafad_tei_models_proxy_ModuleProxy extends metafad_common_models_proxy_SolrQueueProxy
{
    ...
    {
        $this->proxy = pinax_ObjectFactory::createObject('pinaxcms.contents.models.proxy.ModuleContentProxy');
    }
    ...
    public function delete($id, $recurse = false, $control = false)
    {
        ...
        $it =
            $recurse === true ?
                pinax_ObjectFactory::createModelIterator('metafad.tei.models.Manoscritto')
                    ->where('parent', $id)
                    ->allTypes()
                :
                array();
    ...
    {
        $it = pinax_ObjectFactory::createModelIterator('metafad.tei.models.Manoscritto');
