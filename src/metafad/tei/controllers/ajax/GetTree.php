...
class metafad_tei_controllers_ajax_GetTree extends metafad_common_controllers_ajax_CommandAjax
{
    ...
    public function execute($id = null, $getRoot = false)
    {
        ...
        $tree = array();
        if ($getRoot == 'true') {
            $trees = pinax_ObjectFactory::createModelIterator('metafad.tei.models.Model')
    ...
    {
        $ar = pinax_ObjectFactory::createModel('metafad.tei.models.Model');
        ...
        $arChild = pinax_ObjectFactory::createModel('metafad.tei.models.Model');
        ...
        foreach ($it as $ar2) {
            if ($ar2->getId() == $subTree->id) {
                ...
                $it2 = pinax_ObjectFactory::createModelIterator('metafad.tei.models.Model')
                    ->load('getParent', array(':parent' => $arChild->getId(), ':languageId' => pinax_ObjectValues::get('org.pinax', 'languageId')));
