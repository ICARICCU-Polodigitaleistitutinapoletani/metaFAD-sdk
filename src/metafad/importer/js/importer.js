$(document).ready(function(){
    ...
    module.on('change',function(){
        ...
        if(val == 'metafad.sbn.modules.sbnunimarc')
        {
            ...
            $('#partialValidation').parents('.form-group').addClass('hide');
            $('#onlyRecord').parents('.form-group').addClass('hide');
            $('#onlyMedia').parents('.form-group').addClass('hide');
            ...
            $('#partialValidation').parents('.form-group').removeClass('hide');
            $('#onlyValidation').parents('.form-group').removeClass('hide');
            $('#onlyRecord').parents('.form-group').removeClass('hide');
            $('#onlyMedia').parents('.form-group').removeClass('hide');
        }

        if (val.indexOf('aut') == 0 || val.indexOf('bib') == 0) {
            $('#overwriteScheda').parents('.form-group').addClass('hide');
            $('#partialValidation').parents('.form-group').addClass('hide');
            $('#onlyValidation').parents('.form-group').addClass('hide');
            $('#onlyRecord').parents('.form-group').addClass('hide');
            $('#onlyMedia').parents('.form-group').addClass('hide');
        }

        if(val == 'gestione-dati/authority/archivi') {
            $('#overwriteAuthority').parents('.form-group').addClass('hide');
        }
    });
