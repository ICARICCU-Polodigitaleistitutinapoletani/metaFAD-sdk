<?php
class metafad_importer_views_components_FilePicker extends pinax_components_Component
{
    function init()
    {
    ...
    public function render($outputMode=NULL, $skipChilds=false)
    {
        ...
        $storageBrowserUrl = 'index.php?pageId='.$pageId.'&onlyFolder='.$onlyFolder.'&onlyFirstLevel='.$onlyFirstLevel.'&customPath='.$customPath.'&filter='.$filter;
