<?php
class metafad_dam_Common
{
    public static function getDamUrl($damInstance = null)
    {
        return __Config::get('metafad.dam.url').($damInstance ? $damInstance : __Config::get('metafad.dam.instance'));
    }

    public static function getDamBaseUrl()
    {
        return __Config::get('metafad.dam.url');
    }

    public static function getDamUrlLocal($damInstance = null)
    {
        return __Config::get('metafad.dam.url.local').($damInstance ? $damInstance : __Config::get('metafad.dam.instance'));
    }

    public static function getDamBaseUrlLocal()
    {
        return __Config::get('metafad.dam.url.local');
    }
