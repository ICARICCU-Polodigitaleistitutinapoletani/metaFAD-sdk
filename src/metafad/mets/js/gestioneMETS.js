$(document).ready(function(){
  ...
  $('#file').on('click','.deleteMediaButton',function(){
    ...
    {
      $.ajax({
        url: Pinax.ajaxUrl + '&controllerName=metafad.mets.controllers.ajax.DeleteSingleMedia',
        type: 'POST',
        data: {
          id: idMedia
        },
  ...
  $('.btn-dam').on('click',function(){
    ...
    $.ajax({
      url: Pinax.ajaxUrl + '&controllerName=metafad.mets.controllers.ajax.CreateMediaFromDAM',
      type: 'POST',
      data: {
        media: media,
        id: id
  ...
  $('#showElements').on('click','.js-actionStru',function(){
    ...
    if(type == 'saveAll')
    {
      ...
      if(option == 0 || option == 2)
      {
        var importAll = true;
        $.ajax({
          url: Pinax.ajaxUrl + '&controllerName=metafad.mets.controllers.ajax.CreateMedia',
          type: 'POST',
          data: {
            type: type,
            stru: stru,
    ...
    else if(type == 'deleteAll')
    {
      ...
      {
        $.ajax({
          url: Pinax.ajaxUrl + '&controllerName=metafad.mets.controllers.ajax.DeleteMedia',
          type: 'POST',
          data: {
            id: id,
            option: option
    ...
    else if(type == 'saveCheckedMedia')
    {
      ...
      {
        $.ajax({
          url: Pinax.ajaxUrl + '&controllerName=metafad.mets.controllers.ajax.CreateMediaFromList',
          type: 'POST',
          data: {
            stru: stru,
            key: key,
