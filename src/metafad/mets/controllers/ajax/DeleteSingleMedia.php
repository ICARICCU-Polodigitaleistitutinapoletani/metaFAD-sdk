<?php
class metafad_mets_controllers_ajax_DeleteSingleMedia extends metafad_common_controllers_ajax_CommandAjax
{
    public function execute($id)
    {
      ...
      $it = pinax_ObjectFactory::createModelIterator('metafad.mets.models.Publication')
