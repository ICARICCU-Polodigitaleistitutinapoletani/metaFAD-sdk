<?php
class metafad_mets_controllers_ajax_SaveDraft extends metafad_common_controllers_ajax_CommandAjax
{
    public function execute($data)
    {
        ...
        $metsProxy = pinax_ObjectFactory::createObject('metafad.mets.models.proxy.MetsProxy');
